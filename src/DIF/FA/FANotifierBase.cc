...
const simsignal_t FANotifierBase::allocateResponsePositiveSignal = registerSignal(SIG_AERIBD_AllocateResponsePositive);
const simsignal_t FANotifierBase::allocateResponseNegativeSignal = registerSignal(SIG_AERIBD_AllocateResponseNegative);
