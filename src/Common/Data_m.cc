...
EXECUTE_ON_STARTUP(
    ...
    e->insert(SDU_TYPE, "SDU_TYPE");
    e->insert(SDU_FRAGMENT_TYPE, "SDU_FRAGMENT_TYPE");
);

Data_Base::Data_Base(const char *name, int kind) : ::cMessage(name,kind)
{
    this->dataType_var = 0;
}

Data_Base::Data_Base(const Data_Base& other) : ::cMessage(other)
{
    copy(other);
}
...
void Data_Base::parsimPack(cCommBuffer *b)
{
    ::cMessage::parsimPack(b);
    doPacking(b,this->dataType_var);
}

void Data_Base::parsimUnpack(cCommBuffer *b)
{
    ::cMessage::parsimUnpack(b);
    doUnpacking(b,this->dataType_var);
}

unsigned int Data_Base::getDataType() const
{
    return dataType_var;
}

void Data_Base::setDataType(unsigned int dataType)
{
...
{
    return dynamic_cast<Data_Base *>(obj)!=NULL;
}
...
int DataDescriptor::getArraySize(void *object, int field) const
{
    ...
    Data_Base *pp = (Data_Base *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}
...
std::string DataDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    Data_Base *pp = (Data_Base *)object; (void)pp;
    switch (field) {
        case 0: return ulong2string(pp->getDataType());
        default: return "";
    }
}
...
bool DataDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    Data_Base *pp = (Data_Base *)object; (void)pp;
    switch (field) {
        case 0: pp->setDataType(string2ulong(value)); return true;
