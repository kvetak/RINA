...
PDU_Base::PDU_Base(const char *name, int kind) : ::cMessage(name,kind)
{
    this->version_var = 1;
    this->type_var = 0;
    this->flags_var = 0;
...
PDU_Base::PDU_Base(const PDU_Base& other) : ::cMessage(other)
{
    userData_arraysize = 0;
    this->userData_var = 0;
    copy(other);
...
APN& PDU_Base::getDstAddr()
{
    return dstAddr_var;
}

void PDU_Base::setDstAddr(const APN& dstAddr)
{
...
cMessagePtr& PDU_Base::getMUserData()
{
    return mUserData_var;
}

void PDU_Base::setMUserData(const cMessagePtr& mUserData)
{
...
PDUDescriptor::PDUDescriptor() : cClassDescriptor("PDU", "cMessage")
{
}
...
int PDUDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='m' && strcmp(fieldName, "mUserData")==0) return base+9;
...
std::string PDUDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 9: {std::stringstream out; out << pp->getMUserData(); return out.str();}
        default: return "";
    }
}
...
const char *PDUDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        ...
        case 9: return opp_typename(typeid(cMessagePtr));
        default: return NULL;
    };
}
...
void *PDUDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 9: return (void *)(&pp->getMUserData()); break;
        default: return NULL;
    }
}
