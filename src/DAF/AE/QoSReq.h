...
class QoSReq {
  ...
  protected:
    /**
     * @brief Attribute holding QoSReq identifier. Beaware, value 0 is reserved for Flow QoS demands! (This will no longer be an issue)
     */
  ...
  public:
    ...
    /**
     * @brief Gets QoSReq identifier
     * @return QoSReq identifier as unsigned number, where value 0 is reserved for AE's Flow QoS parameters
     */
    unsigned short getQosId() const;

    /**
     * @brief Sets QoSReq identifier
     * @param qoSId A new QoSReq identifier
     */
    ...
    /**
     * @brief Simple QoSReq comparator measuring feasibility score of this and other QoSReqs
    ...
    virtual short countFeasibilityScore(const QoSReq other) const;

    /**
     * @brief Simple QoSReq comparator measuring if this is a feasibility QoSCube to other QoSCubes
